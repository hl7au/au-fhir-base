...
- For support as text representation of other medicinal product information where item form and strength is not included as part of medication definition in `Medication.code.text` consider:
  ...
  - medication ingredient strength in the R5 to R4 pre-adoption extension [ExtensionMedication_Ingredient_Strength](http://hl7.org/fhir/uv/xver-r5.r4/0.1.0/StructureDefinition-ext-R5-Medication.ing.strength.html) on [`Medication.ingredient.strength`](https://www.hl7.org/fhir/R5/medication-definitions.html#Medication.ingredient). See example [Tadim](Medication-IngredientStrengthExtension0.html).
