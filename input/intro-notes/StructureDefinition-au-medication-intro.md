...
- When a `Medication.ingredient.strength` is unavailable as a ratio, ingredient strength text can be surfaced as `CodeableConcept.text` using the pre-adoption of the FHIR R5 [`Medication.ingredient.strength[x]`](https://www.hl7.org/fhir/R5/medication-definitions.html#Medication.ingredient) element with the extension URL [http://hl7.org/fhir/5.0/StructureDefinition/extension-Medication.ingredient.strength[x]](http://hl7.org/fhir/5.0/StructureDefinition/extension-Medication.ingredient.strength[x]). See these examples of use [Stamaril](Medication-IngredientStrengthExtension0.html), [Tadim](Medication-IngredientStrengthExtension1.html). 
