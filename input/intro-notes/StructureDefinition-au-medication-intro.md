...
- When a structured data for `Medication.ingredient.strength` is unavaible ingredient strength can be surfaced as free-text via the backported R5 Medication.ingredient.strengthCodeableConcept extension:
