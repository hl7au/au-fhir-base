...
- When a medication is compounded and is a list of ingredients, `Medication.code` is still present and may contain only the list of ingredients as text in `Medication.code.text`.
