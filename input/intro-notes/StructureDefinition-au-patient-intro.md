<p class="stu-note">We have introduced support for the Person Recorded Sex Or Gender extension, aligning it with the forthcoming changes specified in the R5 <a href="http://hl7.org/fhir/extensions/1.0.0">FHIR Extensions Pack</a> as outlined in <a href="https://jira.hl7.org/browse/FHIR-44514">FHIR-44514</a>. It is published in this guide to pre-adopt the material published in the R5 FHIR Extensions Pack. This extension pre-embraces the material anticipated to be included in the R5 FHIR Extensions Pack, converted for compatibility with R4 (4.0.1). Implementers are advised to take note that this content may be removed or changed and to take caution if using this extension.</p>
