...
[AU eRequesting](https://hl7.org.au/fhir/ereq)|This IG defines a set of conformance requirements for the purpose of implementation of requesting diagnostic services including pathology and imaging. AU eRequesting primarily uses AU Core (inheriting AU Base) or AU Base (when an AU Core profile is not available) as the basis for profiles to be supported.
[AU Patient Summary](https://hl7.org.au/fhir/ps)|This IG defines a set of conformance requirements for the purpose of implementation of repesenting patient summmaries. AU Patient Summary primarily uses AU Core (inheriting AU Base) or AU Base (when an AU Core profile is not available) as the basis for profiles to be supported.
...
[International Patient Summary 2.0.1](https://hl7.org/fhir/uv/ips/2.0.1/en/)|This IG describes how to represent in HL7 FHIR the International Patient Summary (IPS). An International Patient Summary (IPS) document is an electronic health record extract containing essential healthcare information about a subject of care. The profiles in this IG were reviewed and considered during development of AU Base and AU Core. AU Base and AU Core are designed to be compatible with the data requirements of IPS, e.g. AU Core conformant data can be used to generate a patient summary that is conformant to IPS.
{:.grid}
