### HL7 AU FHIR specifications
 AU Base is designed to serve as a base layer within the broader context of FHIR implementations in an Australian healthcare environment. AU Base is definitional in nature and not intended for standalone implementation. It as provides an additional set of localised options to what is available in the FHIR standard including extensions and terminology by introducing concepts specific to the Australian context. This approach ensures that there is a single source of truth for nationally agreed Australian concepts like Medicare card number or Australian Indigenous Status. 
...
This layering of IGs balances the relative adoption and implementation maturity of FHIR and requirements of the use cases involved.
...
The relationship of AU Base to other implementation guides, demonstrating a relationship to downstream IG is shown in the figure below using AU Core.
