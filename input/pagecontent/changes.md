...
<ul>
  ...
  <li>Changes to <a href="StructureDefinition-au-patient.html">AU Base Patient</a>:
    <ul>
      ...
      <li>Added invariant inv-pat-5 to RSG.sourceDocument.jurisdiction to bind Jurisdiction - AU Extended (extensible) (<a href="https://jira.hl7.org/browse/FHIR-43834">FHIR-43834</a>).</li>
    </ul> 
  </li>
  <li>Changes to <a href="StructureDefinition-au-relatedperson.html">AU Base RelatedPerson</a>:
    <ul>
      ...
      <li>Added invariant inv-relper-4 to RSG.sourceDocument.jurisdiction to bind Jurisdiction - AU Extended (extensible) (<a href="https://jira.hl7.org/browse/FHIR-43834">FHIR-43834</a>).</li>
    </ul>
  </li>
  <li>Changes to <a href="StructureDefinition-au-practitioner.html">AU Base Practitioner</a>:
    <ul>
      ...
      <li>Added invariant inv-pra-6 to RSG.sourceDocument.type to bind Jurisdiction - AU Extended (extensible) (<a href="https://jira.hl7.org/browse/FHIR-43834">FHIR-43834</a>).</li>
    </ul>
  </li>
