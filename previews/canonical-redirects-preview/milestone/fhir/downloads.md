# Downloads - AU Base Implementation Guide v6.0.1-ci-build
...
All the profile information for the AU Base Implementation Guide in a single CSV or Excel file, which may be helpful to testers and analysts to review element properties across profiles in a single table:
