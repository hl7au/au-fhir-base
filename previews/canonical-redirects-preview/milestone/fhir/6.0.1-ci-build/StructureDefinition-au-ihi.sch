...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Identifier">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org.au/fhir/StructureDefinition/ihi-verified-date']) &lt;= 1">extension with URL = 'http://hl7.org.au/fhir/StructureDefinition/ihi-verified-date': maximum cardinality of 'extension' is 1</sch:assert>
