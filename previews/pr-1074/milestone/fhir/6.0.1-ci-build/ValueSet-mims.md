# MIMS - AU Base Implementation Guide v6.0.1-ci-build
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:http://terminology.hl7.org.au/ValueSet/mims | *Version*:6.0.1-ci-build | |
...
| *Other Identifiers:*OID:2.16.840.1.113883.2.3.4.2.4.7 | | |
| **Copyright/Legal**: HL7 Australia© 2018+; Licensed Under Creative Commons No Rights Reserved. | | |

 
The MIMS value set includes all values from the Monthly Index of Medical Specialties (MIMS) published by MIMS Australia. Further details can be found at https://www.mims.com.au/. 
...
```json
{
  ...
  "url" : "http://terminology.hl7.org.au/ValueSet/mims",
  "identifier" : [{
    "system" : "urn:ietf:rfc:3986",
    "value" : "urn:oid:2.16.840.1.113883.2.3.4.2.4.7"
  }],
