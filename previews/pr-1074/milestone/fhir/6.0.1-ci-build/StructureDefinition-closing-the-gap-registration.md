# Closing the Gap Registration - AU Base Implementation Guide v6.0.1-ci-build
...
## Extension: Closing the Gap Registration 

| | | |
| :--- | :--- | :--- |
| *Official URL*:http://hl7.org.au/fhir/StructureDefinition/closing-the-gap-registration | *Version*:6.0.1-ci-build | |
| * Standards status: *[Trial-use](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](generalguidance.md#maturity-levels): 3 | *Computable Name*:ClosingTheGapRegistration |
...
* Examples for this Extension: [Patient/example2](Patient-example2.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.au.base|current/StructureDefinition/StructureDefinition-closing-the-gap-registration.json)
...
Other representations of profile: [CSV](StructureDefinition-closing-the-gap-registration.csv), [Excel](StructureDefinition-closing-the-gap-registration.xlsx), [Schematron](StructureDefinition-closing-the-gap-registration.sch) 
