# Location Type (Physical) - AU Extended - AU Base Implementation Guide v6.0.1-ci-build
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:http://terminology.hl7.org.au/ValueSet/location-physical-type-extended | *Version*:6.0.1-ci-build | |
| * Standards status: *[Trial-use](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](generalguidance.md#maturity-levels): 1 | *Computable Name*:LocationPhysicalTypeAUExtended |
...
```json
{
  ...
  "id" : "au-location-physical-type-extended",
  "meta" : {
  ...
  "url" : "http://terminology.hl7.org.au/ValueSet/location-physical-type-extended",
  "identifier" : [{
    "system" : "urn:ietf:rfc:3986",
    "value" : "urn:oid:2.16.840.1.113883.2.3.4.2.4.25"
  }],
  "version" : "6.0.1-ci-build",
  "name" : "LocationPhysicalTypeAUExtended",
  "title" : "Location Type (Physical) - AU Extended",
  "status" : "active",
  "experimental" : false,
