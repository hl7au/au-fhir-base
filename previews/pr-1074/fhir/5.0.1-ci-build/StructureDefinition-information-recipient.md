# Information Recipient - AU Base Implementation Guide v6.0.1-ci-build
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:http://hl7.org.au/fhir/StructureDefinition/information-recipient | *Version*:6.0.1-ci-build | |
| * Standards status: *[Trial-use](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](generalguidance.md#maturity-levels): 1 | *Computable Name*:InformationRecipient |
...
* Use this Extension: [AU Base Composition](StructureDefinition-au-composition.md)
* Examples for this Extension: [Composition/multiple-information-recipients](Composition-multiple-information-recipients.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.au.base|current/StructureDefinition/StructureDefinition-information-recipient.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://hl7.org.au/fhir/StructureDefinition/information-recipient"
    },
    {
