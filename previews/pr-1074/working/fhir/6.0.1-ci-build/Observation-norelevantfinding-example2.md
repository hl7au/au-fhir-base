# Observation - of no relevant finding of known history of conditions - AU Base Implementation Guide v6.0.1-ci-build
...
## Example Observation: Observation - of no relevant finding of known history of conditions
...
**value**: No history of clinical finding in subject
...
```json
{
  ...
  "valueCodeableConcept" : {
    "coding" : [{
      ...
      "code" : "443508001",
      "display" : "No H/O: clinical finding in subject"
    }],
    "text" : "No history of clinical finding in subject"
  }
}
